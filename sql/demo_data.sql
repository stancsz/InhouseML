...
alter table autompg owner to postgres;

insert into public.autompg (mpg, cylinders, displacement, horsepower, weight, acceleration, "model year", origin, "car name")
values  (18, 8, 307, '130', 3504, 12, 70, 1, 'chevrolet chevelle malibu'),
